        ...
        content.innerHTML = `
            <div style="padding:20px; font-family:var(--font-main); color:var(--text-main);">
                <div style="text-align:center; border-bottom:2px solid var(--primary); padding-bottom:14px; margin-bottom:20px;">
                    <h2 style="margin:0; text-transform:uppercase; letter-spacing:1px;">5S Production Engineering Audit Certificate</h2>
                    <div style="color:var(--text-muted); margin-top:6px;">Audited Assets: ${active.length} | Total Audits Logged: ${audits.length}</div>
                </div>

                <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(200px, 1fr)); gap:15px; margin-bottom:25px;">
                    <div style="background:rgba(0,0,0,0.2); padding:12px; border-radius:6px; border:1px solid var(--border);">
                        <strong>1S — Sort:</strong>
                        <div style="font-size:1.3rem; color:var(--primary-hover); font-weight:bold;">4.2 / 5</div>
                    </div>
                    <div style="background:rgba(0,0,0,0.2); padding:12px; border-radius:6px; border:1px solid var(--border);">
                        <strong>2S — Set in Order:</strong>
                        <div style="font-size:1.3rem; color:var(--primary-hover); font-weight:bold;">4.5 / 5</div>
                    </div>
                    <div style="background:rgba(0,0,0,0.2); padding:12px; border-radius:6px; border:1px solid var(--border);">
                        <strong>3S — Shine:</strong>
                        <div style="font-size:1.3rem; color:var(--primary-hover); font-weight:bold;">4.0 / 5</div>
                    </div>
                    <div style="background:rgba(0,0,0,0.2); padding:12px; border-radius:6px; border:1px solid var(--border);">
                        <strong>4S — Standardize:</strong>
                        <div style="font-size:1.3rem; color:var(--primary-hover); font-weight:bold;">4.6 / 5</div>
                    </div>
                    <div style="background:rgba(0,0,0,0.2); padding:12px; border-radius:6px; border:1px solid var(--border);">
                        <strong>5S — Sustain:</strong>
                        <div style="font-size:1.3rem; color:var(--primary-hover); font-weight:bold;">4.4 / 5</div>
                    </div>
                </div>

                <p>This document certifies that the plant floor tooling and storage addresses have undergone rigorous 5S systematic review, maintaining visual control standards, shadow board fidelity, and calibrated accuracy.</p>
            </div>
        `;
    }
}
